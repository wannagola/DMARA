...
export default function OnboardingPage() {
  ...
  // ★ [수정됨] 데이터를 가져와서 imageUrl로 변환하는 핵심 부분
  ...
  return (
    <div className={styles.page} ref={pageRef}>
      <div className={styles.header}>
        <button className={styles.editButton} onClick={startEditingProfile} type="button">Edit</button>
      </div>
        ...
        <div className={styles.profileInfo}>
          {isEditingProfile ? (
            <div className={styles.iamEditContainer}>
              <input className={styles.usernameInput} value={usernameDraft} onChange={(e) => setUsernameDraft(e.target.value)} placeholder="Enter your Nickname" />
              ...
              <button className={styles.iamSaveButton} onClick={saveProfile} type="button">Save</button>
            </div>
          ) : (
            <>
